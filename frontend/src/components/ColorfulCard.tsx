    ...
    >
      ...
      <div className="relative w-full aspect-square overflow-hidden">
        ...
        {scoreBadge != null && scoreBadge > 0 && (
          <div className="absolute top-2 left-2 font-bold text-[13px] bg-brand border-2 border-ink px-1.5 py-0.5 leading-none">
      ...
      <div className="bg-white px-3 py-2 border-t-2 border-ink">
        ...
        <p className="text-[13px] italic text-ink/60 truncate mt-0.5">
          {statusText}
        </p>
      </div>
    </motion.button>
