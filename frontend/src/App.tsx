      ...
      <AuthProvider>
        ...
        <Suspense fallback={<LoadingScreen />}>
          <Routes>
            ...
            {/* Layout あり 10 本: RootLayout を Outlet 親に据えて Protected+Onboarding を共通化 */}
            {/* Phase1: 各ページ内の <Layout> はまだ残存 → 二重になるが Phase2 で撤去する */}
            <Route element={<ProtectedRoute><OnboardingGuard><RootLayout /></OnboardingGuard></ProtectedRoute>}>
              ...
              <Route path="/likes/received" element={<LikesReceivedPage />} />
              <Route path="/settings" element={<SettingsPage />} />
              <Route path="/settings/safety" element={<SafetyListPage />} />
              <Route path="/settings/contact" element={<ContactPage />} />
            </Route>
            {/* Layout なし: profile/edit・chat は個別 Route 維持 */}
