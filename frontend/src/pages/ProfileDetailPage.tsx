      ...
      >
        ...
        <div className="px-4 space-y-4">
          ...
          <div className="card-bold p-4 bg-white space-y-3">
            ...
            {/* 相性バッジ（自分以外・両方のデータがある場合のみ・良い相性のみ表示） */}
            {!isSelf && (() => {
              ...
              return (
                <div
                  className="inline-flex items-center gap-1.5 px-3 py-1 border-2 border-ink font-bold text-xs text-ink"
                  style={{ borderRadius: 9999, background: 'var(--color-brand)' }}
                >
                  {TIER_MESSAGE[tier]}
                </div>
              )
