  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-4 pb-16">
      ...
      <Article id="第4条" title="本人確認情報の特別取扱い">
        ...
        <Sub title="(2) 物理削除の時期">
          <p>本サービスは、本名・学籍番号を取得しません。取得する本人確認情報のうち、学生証画像は以下のタイミングで物理的に削除します。生年月日は審査完了後も在籍確認・年齢確認の記録として保持します。</p>
          <Ul items={[
            '審査において承認された場合: 承認時点から5日以内に学生証画像を削除',
            '審査において不承認となった場合: 不承認時点から31日以内に学生証画像を削除',
      ...
      <Article id="第5条" title="各情報の保存期間">
        ...
        <div className="space-y-1.5">
          {[
            ...
            { label: '学生証画像', value: '審査承認後5日以内・不承認後31日以内・退会時即時削除' },
      ...
      <div className="card-bold bg-white p-4">
        ...
        <p className="font-mono text-xs text-ink/60">本ポリシーは、2026年6月18日に制定・施行し、2026年6月22日に改定しました。</p>
      </div>
    </div>
  )
}
